      ...
      <div className={styles.content}>
        <div className={styles.introContainer}>
          ...
          <p className={styles.description}>
            I specialize in creating modern, scalable web and mobile applications using clean code and thoughtful design. 
  I focus on delivering functional, intuitive, and polished solutions that provide real value to users.
          </p>
